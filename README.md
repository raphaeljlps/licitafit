...
- `para-parceiros/` , LP API para parceiros de software (parceiros de software)
- `para-empresas/` , LP Dashboard para empresas (equipes de licitação; R$ 399/mês + R$ 5 por licitação monitorada/mês)
